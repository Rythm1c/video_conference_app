"""
Django settings for whiteboard_backend project.
...
SECRET_KEY = "django-insecure-mp4ro7yz_(&8htclq)+@9$xu&8p*$uqdki*m)a)#p*e8p&@gzm"
...
WSGI_APPLICATION = "whiteboard_backend.wsgi.application"
